...
(function($, window, document, undefined){
    ...
    $(function(){
        ...
        $('.elsie-install-now').on( 'click', function( event ) {
            ...
            function buttonStatusInProgress( message ){
                $button.addClass('updating-message').removeClass('button-disabled elsie-pi-not-installed installed').text( message );
            }
            ...
            function buttonStatusDisabled( message ){
                $button.removeClass('updating-message elsie-pi-not-installed installed')
            ...
            function buttonStatusInstalled( message ){
                $button.removeClass('updating-message elsie-pi-not-installed')
                        .addClass('installed')
                        .text( message );
            }
