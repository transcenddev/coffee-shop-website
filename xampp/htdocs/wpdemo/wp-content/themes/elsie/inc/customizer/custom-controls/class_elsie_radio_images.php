...
class Elsie_Radio_Images extends WP_Customize_Control {

	/**
	 * The type of customize control being rendered.
	 */
	public $type = 'elsie-radio-image';
	...
	public function render_content() {		
		...
		<div id="<?php echo esc_attr( "input_{$this->id}" ); ?>" class="elsie-radio-images-control columns-<?php echo esc_attr( $this->columns ); ?>">
