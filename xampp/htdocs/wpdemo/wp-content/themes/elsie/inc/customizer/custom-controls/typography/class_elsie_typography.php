<?php
class Elsie_Typography_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'elsie-google_fonts';
		/**
		...
		public function enqueue() {
			wp_enqueue_script( 'elsie-select2-js', get_template_directory_uri() . '/inc/customizer/custom-controls/typography/select2.full.min.js', array( 'jquery' ), '4.0.13', true );
			wp_enqueue_style( 'elsie-select2-css', get_template_directory_uri() . '/inc/customizer/custom-controls/typography/select2.min.css', array(), '4.0.13', 'all' );
		}
		/**
		...
		public function to_json() {
			parent::to_json();
			$this->json['elsiefontslist'] = $this->fontList;
		}
		/**
			...
			if( !empty($this->fontList) ) {
				...
				<div class="google_fonts_select_control popover-block">
					...
					<div class="google-fonts">
						<div class="font-control-title"><strong><?php esc_html_e( 'Font family', 'elsie' ) ?></strong></div>
					...
					<div class="font-control-title w50"><strong><?php esc_html_e( 'Font weight', 'elsie' ) ?></strong></div>
		...
		public function get_google_fonts( $count = 30 ) {
			$fontFile = get_template_directory_uri() . '/inc/customizer/custom-controls/typography/google-fonts-alphabetical.json';
